...
class RouteGuideStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetInformation = channel.unary_unary(
                '/RouteGuide/GetInformation',
                request_serializer=service__pb2.urmom.SerializeToString,
...
def add_RouteGuideServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetInformation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.urmom.FromString,
...
class RouteGuide(object):
    ...
    def GetInformation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/RouteGuide/GetInformation',
            service__pb2.urmom.SerializeToString,
